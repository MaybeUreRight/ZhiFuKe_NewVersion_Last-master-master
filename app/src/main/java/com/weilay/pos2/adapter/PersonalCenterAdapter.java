...
public class PersonalCenterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PersonalCenterAdapter(Context context, ArrayList<PersonalCenterBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //负责创建视图
        View view = LayoutInflater.from(context).inflate(R.layout.item_personalcenter, parent, false);
