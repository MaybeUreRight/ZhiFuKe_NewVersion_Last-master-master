...
package com.weilay.pos2.recyclerview.manager;
...
//        LogUtils.i("Item onLayoutChildren state = " + state);
...
//        LogUtils.i("displayRect = " + displayRect.toString());
...
//        LogUtils.i("child count = " + getChildCount());
    }
...
//        LogUtils.i("computeScrollVectorForPosition next = " + page);
    ...
    int findPrePageFirstPos() {
        ...
        int page = mLastPageIndex;
        page--;
//        LogUtils.i("computeScrollVectorForPosition pre = " + page);
        if (page < 0) {
            page = 0;
        }
//        LogUtils.i("computeScrollVectorForPosition pre = " + page);
...
//        LogUtils.i("setPageIndex = " + pageIndex + ":" + isScrolling);
...
//        LogUtils.i("mTargetOffsetXBy = " + mTargetOffsetXBy);
//        LogUtils.i("mTargetOffsetYBy = " + mTargetOffsetYBy);
