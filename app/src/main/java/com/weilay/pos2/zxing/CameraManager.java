...
//    private static final int MAX_FRAME_HEIGHT = 360;
    ...
    public static void init(Context context) {
        LogUtils.i("cameraManager init");
        LogUtils.i("cameraManager is null?" + (cameraManager == null));
...
//			int height = (int) (screenResolution.y * 0.8);
//			int leftOffset = (screenResolution.x - width) / 4;
//			int topOffset = (screenResolution.y - height) / 6;
            int width = (int) (screenResolution.x);
            int height = (int) (screenResolution.y);
            int leftOffset = 0;
            int topOffset = 0;
            if (width < height) {
                height = width;
            ...
            LogUtils.i("screenResolution.x = " + screenResolution.x);
            LogUtils.i("screenResolution.y = " + screenResolution.y);
            LogUtils.i("width = " + width);
            LogUtils.i("height = " + height);

//			int leftOffset = 10;
//			int topOffset = 10;
            framingRect = new Rect(leftOffset, topOffset, leftOffset + width, (int) (topOffset + height ));
        }
        return framingRect;
    }
