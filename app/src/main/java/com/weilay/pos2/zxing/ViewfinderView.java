...
public final class ViewfinderView extends View {
    ...
    private double ScanSize = 1;

    /**
     * @param scanSize 1为缩放高度100%,0.9为缩放高度90%
     */
    public void setScanSize(double scanSize) {
        ScanSize = scanSize;
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        int top = frame.top;
        int bottom = (int) (frame.bottom * ScanSize);
        int left = frame.left;
        int right = (int) (frame.right * ScanSize);
        ...
        if (resultBitmap != null) {
            ...
            canvas.drawRect(left + MIDDLE_LINE_PADDING, slideTop
                            - MIDDLE_LINE_WIDTH / 2, right - MIDDLE_LINE_PADDING,
            ...
            if (currentPossible.isEmpty()) {
                ...
                for (ResultPoint point : currentPossible) {
                    canvas.drawCircle(left + point.getX(), top + point.getY(),
                            6.0f, paint);
                }
            }
            if (currentLast != null) {
