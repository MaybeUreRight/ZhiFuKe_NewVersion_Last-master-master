...
public class DecodeFormatManager {
	...
	public static Set<BarcodeFormat> PRODUCT_FORMATS;
	public static Set<BarcodeFormat> INDUSTRIAL_FORMATS;
	public static Set<BarcodeFormat> ONE_D_FORMATS;
	public static Set<BarcodeFormat> QR_CODE_FORMATS = EnumSet.of(BarcodeFormat.QR_CODE);
	public static Set<BarcodeFormat> DATA_MATRIX_FORMATS = EnumSet.of(BarcodeFormat.DATA_MATRIX);
	public static Set<BarcodeFormat> AZTEC_FORMATS = EnumSet.of(BarcodeFormat.AZTEC);
	public static Set<BarcodeFormat> PDF417_FORMATS = EnumSet.of(BarcodeFormat.PDF_417);
	static {
