...
public final class ActivityUtils {
    ...
    public static void init(@NonNull final Application app) {
        ...
        ActivityUtils.sApplication.registerActivityLifecycleCallbacks(mCallbacks);
    }
    ...
    static Context getTopActivityOrApp() {
        if (isAppForeground()) {
            ...
            return topActivity == null ? ActivityUtils.getApp() : topActivity;
        } else {
    ...
    static boolean isAppForeground() {
        ActivityManager am =
                (ActivityManager) ActivityUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
