...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = ActivityUtils.getApp()
                    .getPackageManager()
                    .getPackageInfo(ActivityUtils.getApp().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                ...
                mDefaultDir = ActivityUtils.getApp().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                mDefaultDir = ActivityUtils.getApp().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
